...
Hosted upgrades must run the normal privileged `prepare:hosted` job after
migration 029. It grants the curated Core runtime role access to the two new
ordinary application tables; the startup role-separation gate fails closed
