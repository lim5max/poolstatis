...
export class EventManagementService {
  ...
  private async prepareBackfill(
    ...
    rawEvents.forEach((raw, index) => {
      ...
      const acquisitionError = validateAcquisitionProperties(properties, event.session_id);
      if (acquisitionError) {
  ...
  private async applyAndValidatePatch(
    ...
    const acquisitionError = validateAcquisitionProperties(properties, sessionId ?? undefined);
