    ...
    <div className="space-y-5">
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div className="min-w-0">
          ...
          <button
            className="mt-1 flex max-w-full items-center gap-1 font-mono text-xs text-muted-foreground hover:text-primary"
              ...
              <>
                <div className="divide-y">
                  {data.activity.events.map((event, index) => (
                    <div key={`${event.timestamp}:${event.event}:${index}`} className="grid gap-2 py-3 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center">
                      <div className="min-w-0">
